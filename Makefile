...
NAME=libftprintf.a
DNAME=printf_debug
FILES=ft_printf.c printf_conv_char.c printf_conv_int.c printf_fill_list.c printf_flags_show.c printf_funcs.c printf_get_params.c printf_make_str.c printf_parse.c printf_process_conv.c
